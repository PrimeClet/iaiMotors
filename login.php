...
<head>
    ...
    <title>IAI MOTORS - Service de réparation de Voitures</title>
...
<div class="session">
    ...
    <form action="traitements/login-traitement.php" method="post" class="log-in" autocomplete="off">
        <h4>Nous Sommes <span style="color: #d81324">IAI-MOTORS</span>
        </h4>
        <p>Content de te revoir! Connectez-vous à votre compte</p>
        <div class="floating-label">
            <input placeholder="iai-motors" type="text" name="username" id="email" autocomplete="off">
        ...
        <a href="index.php" class="discrete" target="_blank">Retourner à l'Accueil</a>
    </form>
</div>
</body>
</html>