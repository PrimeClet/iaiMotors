<?php
    ...
    $count = $dataEmploye->Id_employer;
    $service = $services->getService($dataEmploye->Id_service)[0];
    $direction = $directions->getDirection($dataEmploye->Id_direction)[0];
                    ...
                    <div class="col-xxl-8 offset-xxl-2 col-md-6">
                        <div class="card info-card sales-card">
                            ...
                            <div class="card-body p-5">
                                ...
                                <div class="card">
                                    <div class="card-body p-5">
                                        <h5 class="card-title">Modifier Un Employé <i class="bi bi-person-fill-add"></i></h5>

                                        <!-- Floating Labels Form -->
                                        <form id="modifyEmploye" class="row g-3" action="../../traitements/employe-modify.php" method="post">
                                            <div class="col-md-12">
                                                <div class="form-floating">
                                                    <input type="text" class="form-control" id="floatingName" name="nom" placeholder="Nom de l'employé" value="<?= $dataEmploye->Nom_employer ?>" required>
                                                    <label for="floatingName">Nom Employé<span style="color: red">*</span></label>
                                                </div>
                                            </div>
                                            <div class="col-md-12">
                                                <div class="form-floating">
                                                    <input type="text" class="d-none form-control" id="f" name="id" placeholder="Nom de l'employé" value="<?= $count ?>">
                                                </div>
                                            </div>
                                            <div class="col-md-12">
                                                <div class="form-floating">
                                                    <input type="text" class="form-control" id="floatingSurname" name="prenom" placeholder="PreNom de l'employé" value="<?= $dataEmploye->Prenom_employer ?>">
                                                    <label for="floatingSurname">Prenom Employé<span style="color: red">*</span></label>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-floating">
                                                    <input type="email" class="form-control" id="floatingEmail" name="email" placeholder="Email Employé" value="<?= $dataEmploye->email ?>" required>
                                                    <label for="floatingEmail">Email Employé<span style="color: red">*</span></label>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-floating">
                                                    <input type="text" class="form-control" id="floatingUsername" name="username" placeholder="Username Employé" value="<?= $dataEmploye->username ?>" required>
                                                    <label for="floatingEmail">Username Employé<span style="color: red">*</span></label>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-floating">
                                                    <input type="text" class="form-control" id="floatingMatricule" value="<?= $dataEmploye->Matricule ?>" placeholder="Matricule" name="matricule" data-value="<?= $yearNbre; ?>" required>
                                                    <label for="floatingMatricule">Matricule</label>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-floating">
                                                    <input type="password" class="form-control" id="floatingPassword" value="<?= $dataEmploye->Matricule ?>" placeholder="Password" name="password" required>
                                                ...
                                                <div class="form-floating mb-3">
                                                    <select class="form-select" id="floatingDirection" aria-label="Direction" name="direction">
                                                        ...
                                                        foreach ($dataDirection as $data) {
                                                            ?>
                                                            <option value="<?= $data->Id_direction ?>" data-value="<?= $data->code_direction ?>" <?php if ($dataEmploye->Id_direction === $data->Id_direction) { echo "selected";} ?> ><?= $data->Nom_direction ?></option>
                                                        <?php } ?>
                                                    </select>
                                                ...
                                                <div class="form-floating">
                                                    <select class="form-select" id="floatingService" aria-label="Service" name="service">
                                                        ...
                                                        foreach ($dataService as $datas) {
                                                            ?>
                                                            <option value="<?= $datas->Id_service ?>" data-label="<?= $datas->Id_direction ?>" <?php if ($dataEmploye->Id_service === $datas->Id_service) { echo "selected";} ?> data-value="<?= $datas->code_service ?>"><?= $datas->Nom_service ?></option>
                                                        <?php } ?>
                                                    </select>
                                            ...
                                            <div class="col-md-3">
                                                <div class="col-md-12 form-floating">
                                                    <select class="form-select" id="floatingCategorie" aria-label="Categorie" name="categorie">
                                                        <option  value="Employe" <?php if ($dataEmploye->Categorie === "Employe") { echo "selected";} ?>>Employe</option>
                                                        <option value="Technicien" <?php if ($dataEmploye->Categorie === "Technicien") { echo "selected";} ?>>Technicien</option>
                                                    </select>
                                                ...
                                                <fieldset class="row mb-3">
                                                    ...
                                                    <div class="col-sm-3 d-flex gap-3">
                                                        <div class="form-check">
                                                            <input class="form-check-input" type="radio" name="directeur" id="directeur1" value="oui" <?php if ($dataEmploye->Id_employer === $direction->Id_employer) { echo "checked";} ?>>
                                                            <label class="form-check-label" for="directeur1">
                                                                Oui
                                                            </label>
                                                        </div>
                                                        <div class="form-check">
                                                            <input class="form-check-input" type="radio" name="directeur" id="directeur2" value="non" <?php if ($dataEmploye->Id_employer !== $direction->Id_employer) { echo "checked";} ?>>
                                            ...
                                            <div class="col-md-6">
                                                <fieldset class="row mb-3">
                                                    ...
                                                    <div class="col-sm-4 d-flex gap-3">
                                                        <div class="form-check">
                                                            <input class="form-check-input" type="radio" name="cs" id="cs1" value="oui" <?php if ($dataEmploye->Id_employer === $service->Id_employer) { echo "checked";} ?>>
                                                            <label class="form-check-label" for="cs1">
                                                                Oui
                                                            </label>
                                                        </div>
                                                        <div class="form-check">
                                                            <input class="form-check-input" type="radio" name="cs" id="cs2" value="non" <?php if ($dataEmploye->Id_employer !== $service->Id_employer) { echo "checked";} ?>>
                                            ...
                                            <div class="text-center">
                                                <button type="submit" class="btn btn-primary" id="sendEmployeValue"><i class="bi bi-person-fill-add"></i> Modifier L'Employé</button>
    ...
    $(document).ready(function () {
        ...
        submit.onclick = function (event) {
            ...
            if (direction.value !== service.options[service.selectedIndex].getAttribute("data-label")){
                ...
                document.getElementById("modifyEmploye").submit()
            }
        }
