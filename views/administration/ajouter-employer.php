                    ...
                    <div class="col-xxl-8 offset-xxl-2 col-md-6">
                        <div class="card info-card sales-card">
                            ...
                            <div class="card-body p-5">
                                ...
                                <div class="card">
                                    <div class="card-body p-5">
                                        <h5 class="card-title">Ajouter Un Employé <i class="bi bi-person-fill-add"></i></h5>

                                        <!-- Floating Labels Form -->
                                        <form id="addEmploye" class="row g-3" action="../../traitements/employe-traitement.php" method="post">
                                            <div class="col-md-12">
                                                <div class="form-floating">
                                                    <input type="text" class="form-control" id="floatingName" name="nom" placeholder="Nom de l'employé" required>
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-floating">
                                                    <input type="text" class="form-control" id="floatingSurname" name="prenom" placeholder="PreNom de l'employé">
                                                    <label for="floatingSurname">Prenom Employé<span style="color: red">*</span></label>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-floating">
                                                    <input type="email" class="form-control" id="floatingEmail" name="email" placeholder="Email Employé" required>
                                                    <label for="floatingEmail">Email Employé<span style="color: red">*</span></label>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-floating">
                                                    <input type="text" class="form-control" id="floatingUsername" name="username" placeholder="Username Employé" required>
                                                    <label for="floatingEmail">Username Employé<span style="color: red">*</span></label>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-floating">
                                                    <input type="text" class="form-control" id="floatingMatricule" placeholder="Matricule" name="matricule" data-value="<?= $yearNbre; ?>" required>
                                            ...
                                            <div class="col-12">
                                                <div class="form-floating">
                                                    <input class="form-control" type="text" placeholder="Address" id="floatingAdress" name="adresse" required>
                                                    <label for="floatingAdress">Addresse<span style="color: red">*</span></label>
                                                </div>
                                            </div>
                                            <div class="col-md-5">
