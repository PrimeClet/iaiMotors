                    ...
                    <div class="col-12">
                        <div class="card recent-sales">
                            <div class="filter pr-4">
                                <a href="../administration/service-ajout.php" class="btn btn-outline-primary btn-sm mr-4"><i class="bi bi-plus-circle-fill"></i> Ajouter Service</a>
                            </div>
                            <div class="card-body">
                                <h5 class="card-title">Liste des services <span>| Aujourd'hui</span></h5>
                                        ...
                                        <table class="table table-borderless datatable dataTable-table">
                                            ...
                                            <tr>
                                                <th scope="col" data-sortable="" style="width: 30.9111%;">
                                                    <a href="#" class="dataTable-sorter">Nom Service</a>
                                                </th>
                                                <th scope="col" data-sortable="" style="width: 10.9635%;">
                                                    <a href="#" class="dataTable-sorter">Code Service</a>
                                                </th>
                                                <th scope="col" data-sortable="" style="width: 25.1772%;">
                                                    <a href="#" class="dataTable-sorter">Direction Asssocie</a>
                                                </th>
                                                <th scope="col" data-sortable="" style="width: 10.89134%;">
                                                    <a href="#" class="dataTable-sorter">Chef Du Service</a>
                                                </th>
                                            ...
                                            <?php foreach ($dataService as $data) { ?>
                                                <tr <?php if($data->status === 0) { ?> >
                                                    <th scope="row" style="vertical-align: middle;">
                                                        <a href="#"><?= $data->Nom_service ?></a>
                                                    </th>
                                                    <td style="vertical-align: middle;"><?= $data->code_service ?></td>
                                                    <td style="vertical-align: middle;"><?= $directions->getDirection($data->Id_direction)[0]->Nom_direction ?></td>
                                                    <td style="vertical-align: middle;">
                                                        <?php if ($data->Id_employer !== NULL) { ?>
                                                            <span class="badge bg-success"><?= $employes->getEmploye($data->Id_employer)[0]->Nom_employer ?></span>
                                                        <?php }?>
                                                        <?php if ($data->Id_employer === NULL) { ?>
                                                            <span class="badge bg-danger text-dark">Pas de Chef Associé</span>
                                                        <?php }?>
                                                    </td>
                                                    <td style="vertical-align: middle;">
                                                        <p class="d-flex gap-1">
                                                            <button  class="btn btn-outline-success btn-sm"><i class="bi bi-eye-fill" data-bs-toggle="modal" data-bs-target="#details<?= $data->Id_service ?>"></i></button>
                                                            ...
                                                            <button  class="btn btn-outline-warning btn-sm"><i class="bi bi-pencil" data-bs-toggle="modal" data-bs-target="#modify<?= $data->Id_service ?>"></i></button>
                                                        </p>
                                                    </td>
                                                    <div class="modal fade" id="details<?= $data->Id_service ?>" tabindex="-1" aria-hidden="true" style="display: none;">
                                                                ...
                                                                <div class="modal-body">
                                                                    <div class="col-md-12 my-2">
                                                                        <div class="form-floating">
                                                                            <input type="text" class="form-control" id="floatingName" placeholder="Nom Service" value="<?=$data->Nom_service ?>" disabled>
                                                                            <label for="floatingName">Nom Service</label>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-md-12 my-2">
                                                                        <div class="form-floating">
                                                                            <input type="text" class="form-control" id="floatingcode" placeholder="Code Service" value="<?=$data->code_service ?>" disabled>
                                                                            <label for="floatingcode">Code Service</label>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-md-12 my-2">
                                                                        <div class="form-floating">
                                                                            <input type="text" class="form-control" id="direction" placeholder="Direction Associée" value="<?= $directions->getDirection($data->Id_direction)[0]->Nom_direction ?>" disabled>
                                                                            <label for="direction">Direction Associée</label>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-md-12 my-2">
                                                                        <div class="form-floating">
                                                                            <input type="text" class="form-control" id="directeur" placeholder="Direction Associée" value="<?= ($data->Id_employer !== NULL) ? $employes->getEmploye($data->Id_employer)[0]->Nom_employer : 'Pas encore Attribué' ?>" disabled>
                                                                            <label for="directeur">Directeur Associé</label>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                <div class="modal-footer">
                                                                    <button type="button" id="close<?= $data->Id_service ?>" class="btn btn-outline-primary" data-bs-dismiss="modal">Annuler</button>
                                                    ...
                                                    <div class="modal fade" id="modify<?= $data->Id_service ?>" tabindex="-1" aria-hidden="true" style="display: none;">
                                                        <div class="modal-dialog modal-dialog-centered">
                                                            <div class="modal-content">
                                                                <div class="modal-header">
                                                                ...
                                                                <div class="modal-body">
                                                                    <div class="col-md-12 my-2">
                                                                        <div class="form-floating mb-3">
                                                                            <input type="text" class="form-control" id="floatingcode" placeholder="Code Service" value="<?= $data->Nom_service ?>">
                                                                            <label for="floatingDirection">Nom Service</label>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-md-12 my-2">
                                                                        <div class="form-floating">
                                                                            <input type="text" class="form-control" id="floatingcode" placeholder="Code Service" value="<?=$data->code_service ?>">
                                                                            <label for="floatingcode">Code Service</label>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-md-12 my-2">
                                                                        <div class="form-floating mb-3">
                                                                            <select class="form-select" id="floatingDirection" aria-label="Direction" name="direction">
                                                                                ...
                                                                                foreach ($dataDirection as $datas) {
                                                                                    ?>
                                                                                    <option value="<?= $datas->Id_direction ?>" data-value="<?= $datas->code_direction ?>" <?php if ($data->Id_direction === $datas->Id_direction) { echo "selected";} ?> ><?= $datas->Nom_direction ?></option>
                                                                                <?php } ?>
                                                                            </select>
                                                                    ...
                                                                    <div class="col-md-12 my-2">
                                                                        <div class="form-floating mb-3">
                                                                            ...
                                                                            <label for="floatingDirecteur">Chef Service Associé</label>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                <div class="modal-footer">
                                                                    <button type="button" id="close<?= $data->Id_service ?>" class="btn btn-outline-primary" data-bs-dismiss="modal">Annuler</button>
                                                                    <button type="button" class="btn btn-outline-danger" onclick="modifierService('modify<?= $data->Id_service ?>', <?= $data->Id_service ?>)">Modifier</button>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
...
<script>
    function modifierService(data, ids) {
        let id = "close"+ids
        ...
        datas = {
            ...
            idChefService: directeur
        }
        const xhttp = new XMLHttpRequest();
        xhttp.open("POST", "../../traitements/modifier-service.php", true);
